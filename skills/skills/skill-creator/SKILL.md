---
name: skill-creator
description: Guide for creating effective skills. This skill should be used when users want to create a new skill (or update an existing skill) that extends AI assistant capabilities with specialized knowledge, workflows, or tool integrations.
...
Skills are modular, self-contained packages that extend AI assistant capabilities by providing
specialized knowledge, workflows, and tools. Think of them as "onboarding guides" for specific
domains or tasks—they transform the AI assistant from a general-purpose agent into a specialized agent
...
**Default assumption: The AI assistant is already very smart.** Only add context the AI assistant doesn't already have. Challenge each piece of information: "Does the AI assistant really need this explanation?" and "Does this paragraph justify its token cost?"
...
Files not intended to be loaded into context, but rather used within the output the AI assistant produces.

- **When to include**: When the skill needs files that will be used in the final output
- **Examples**: `assets/logo.png` for brand assets, `assets/slides.pptx` for PowerPoint templates, `assets/frontend-template/` for HTML/React boilerplate, `assets/font.ttf` for typography
- **Use cases**: Templates, images, icons, boilerplate code, fonts, sample documents that get copied or modified
- **Benefits**: Separates output resources from documentation, enables the AI assistant to use files without loading them into context
...
3. **Bundled resources** - As needed by the AI assistant (Unlimited because scripts can be executed without reading into context window)
...
- **Structure longer reference files** - For files longer than 100 lines, include a table of contents at the top so the AI assistant can see the full scope when previewing.
...
When editing the (newly-generated or existing) skill, remember that the skill is being created for another AI assistant instance to use. Include information that would be beneficial and non-obvious to the AI assistant. Consider what procedural knowledge, domain-specific details, or reusable assets would help another AI assistant instance execute these tasks more effectively.
